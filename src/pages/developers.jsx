        ...
        <div className="home-wrapper">
          <div className="container main">
            <div className="content">
              ...
              <p>
                While our API and search engine is free for educational,
                non-profit &amp; open-source projects, commercial usage requires
                a separate license. Please contact us if you want to use it
                commercially.
              </p>
